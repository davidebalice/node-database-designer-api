...
router.route('/user/img/:filename').get(authController.protect, userController.userImg);
...
router.route('/send/email/user').post(demoMode, authController.protect, userController.userEmail);
